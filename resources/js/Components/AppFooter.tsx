...
const SOCIALS = [
    {
        label: 'Instagram',
        href: 'https://www.instagram.com/pomosupport/',
        icon: (
    ...
    {
        label: 'TikTok',
        href: 'https://www.tiktok.com/@pomobloom',
        icon: (
            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
        label: 'Reddit',
        href: 'https://www.reddit.com/user/Pomobloom/',
        icon: (
...
export default function AppFooter() {
    ...
    return (
        <footer className="border-t border-boundary/40 bg-depth/60 px-6 py-6">
